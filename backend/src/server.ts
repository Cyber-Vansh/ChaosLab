  ...
  passport.use(new GoogleStrategy(
    {
      ...
      callbackURL: `${(process.env.BACKEND_URL || 'http://localhost:3000').endsWith('/') ? (process.env.BACKEND_URL || 'http://localhost:3000').slice(0, -1) : (process.env.BACKEND_URL || 'http://localhost:3000')}/auth/google/callback`,
    },
